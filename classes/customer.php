...
<?php 
	...
	*/
	class customer
	{
		...
		{
			$prouduct_id=$_POST['product_id_binhluan'];
			...
			if($tennguoibinhluan=="" || $binhluan=="" ){
				...
				$query = "INSERT INTO tbl_binhluan(tenbinhluan,binhluan,product_id) VALUES('$tennguoibinhluan','$binhluan','$prouduct_id') ";
				$result = $this->db->insert($query);
				if($result){
						$alert = "<span class='success'>Khách hàng Binh luan thành công</span>";
						return $alert;
				}else{
						$alert = "<span class='error'>Khách hàng Binh luan Not thành công</span>";
						return $alert;
				}
