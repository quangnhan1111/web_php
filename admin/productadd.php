...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
        // isset($_POST['submit'] nhan vao submit moi Add
        // LẤY DỮ LIỆU TỪ PHƯƠNG THỨC Ở FORM POST
        $insertProduct = $pd -> insert_product($_POST, $_FILES); // hàm check catName khi submit lên
        // $_POST lay tat ca du lieu khi nhan submit qua bien $_POST
        // $_FILES chua hinh anh
    }
  ?>
<div class="grid_10">
    <div class="box round first grid">
        ...
        <div class="block">
         ...
         <!-- enctype="multipart/form-data" danh cho them hinh anh -->
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <select id="select" name="category">
                            ...
                            <!-- much dich cua value= php echo $result['catId'] la de them catId vao CSDL vi table product co cac thuoc tinh la
                            IdName Name Idcat Idbrand price image des type  -->
