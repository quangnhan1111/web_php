        ...
        <div class="grid_12 header-repeat">
            <div id="branding">
                <div class="floatleft logo">
                    <a href="index.php"><img src="img/livelogo.png" alt="Logo" /></a>
				</div>
                    ...
                    <div class="floatleft marginleft10">
                        <ul class="inline-ul floatleft">
                            ...
                            <?php 
                             ...
                             ?>
                             <!-- chuc nang logout -->
                             <!-- neu ton tai action va action la logout  huy phien
                             roi quay tro lai Login.php-->
